...
public class ViewPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(0, 118, 157));
        ...
        jScrollPane1.setBackground(new java.awt.Color(100, 141, 189));
        ...
        jButton1.setForeground(new java.awt.Color(238, 245, 255));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ResultSet rs = service.ViewService.viewUser();
        if(rs!=null){
            jTable1.setModel(DbUtils.resultSetToTableModel(rs));
        }
        else{
            JOptionPane.showMessageDialog(null,"There is no data stored.");
        }
