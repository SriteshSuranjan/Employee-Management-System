...
import service.ForgotPWService;

/**
 *
 * @author srite
 */
public class ForgotPWPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton2.setForeground(new java.awt.Color(238, 245, 255));
        ...
        jPanel2.setBackground(new java.awt.Color(67, 85, 133));
        ...
        jLabel5.setText("Kindly Remember Your");

        jLabel7.setFont(new java.awt.Font("PMingLiU-ExtB", 1, 24)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText("New Password.");

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/ChangePW.png"))); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        boolean b = service.ForgotPWService.forgotPWUser(username, password);
        if(b){
            JOptionPane.showMessageDialog(null,"Password Changed Successfully");
        }else {
            JOptionPane.showMessageDialog(null,"Not Yet Changed");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ForgotPWPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
