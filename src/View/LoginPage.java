...
public class LoginPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(112, 113, 232));

        jLabel1.setFont(new java.awt.Font("STLiti", 1, 36)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(247, 239, 229));
        jLabel1.setText("Hello , Friend !");

        jLabel5.setFont(new java.awt.Font("Segoe UI Semibold", 1, 15)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(247, 239, 229));
        jLabel5.setText("Don't have an account?");

        jLabel6.setFont(new java.awt.Font("Segoe UI Symbol", 1, 15)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(247, 239, 229));
        jLabel6.setText("Please Sign up!");
        ...
        jLabel3.setBackground(new java.awt.Color(22, 72, 99));
        jLabel3.setFont(new java.awt.Font("Serif", 1, 16)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(22, 72, 99));
        ...
        jLabel4.setBackground(new java.awt.Color(22, 72, 99));
        jLabel4.setFont(new java.awt.Font("Serif", 1, 16)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(22, 72, 99));
        jLabel4.setText("PASSWORD");

        jLabel7.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(22, 72, 99));
        ...
        jButton2.setBackground(new java.awt.Color(22, 72, 99));
        jButton2.setFont(new java.awt.Font("Segoe UI Variable", 1, 14)); // NOI18N
        jButton2.setForeground(new java.awt.Color(221, 242, 253));
        ...
        jButton3.setForeground(new java.awt.Color(221, 242, 253));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String passwords = jPasswordField1.getText();
        if(service.LoginService.validUser(username, passwords)){
    ...
    private void jLabel7MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel7MouseClicked
        setVisible(false);
        new ForgotPWPage().setVisible(true);
